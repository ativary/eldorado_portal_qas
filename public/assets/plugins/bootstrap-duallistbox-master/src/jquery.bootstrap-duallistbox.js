  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i').removeClass('fa fa-forward').addClass('icon-arrow-right');
        this.container.find('.removeall > i').removeClass('fa fa-backward').addClass('icon-arrow-left');
      } else {
        ...
        this.container.find('.moveall > i').html('<i class="fa fa-plus" aria-hidden="true"></i> Adicionar todos');
        this.container.find('.removeall > i').html('<i class="fa fa-times" aria-hidden="true"></i> Remover todos');
      }
      if (refresh) {
        refreshSelects(this);
      }
