...
class Breadcrumb
{
    ...
    public function add($crumb, $href = false)
    {
    ...
    public function render()
    {
        ...
        foreach ($this->breadcrumbs as $index => $breadcrumb) {
            ...
            if ($index == $count) {
                ...
                if(isset($breadcrumb['href'])) $output .= '<a href="' . base_url($breadcrumb['href']) . '">';
                $output .= $breadcrumb['crumb'];
                if(isset($breadcrumb['href'])) $output .= '</a>';
                $output .= $this->tags['liclose'];
            }
        }
