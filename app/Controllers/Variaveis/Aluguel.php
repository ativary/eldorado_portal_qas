...
Class Aluguel extends BaseController {
    ...
    public function index()
    {
        ...
        parent::VerificaPerfil('VARIAVEIS_ALUGUEL');
        $dados['_titulo'] = "Auxilio Aluguel";
        ...
        $dados['listaReqs']     = $this->mParam->getReq(7, $dados['data_inicio'],$dados['data_fim'],$dados['funcionario'],false, $dados['situacao'] );
       
        $dados['listaSecao']    = $this->mParam->listaSecaoGestor( $dados['rh']);

        return parent::ViewPortal('variaveis/aluguel/index', $dados);

    }

    public function novo(){
        parent::VerificaPerfil('VARIAVEIS_ALUGUEL');
        $dados['_titulo'] = "Novo Auxilio Aluguel";
        $dados['rh'] = parent::VerificaPerfil('GLOBAL_RH', false);
        $dados['resFuncionarioSecao'] = $this->mParam->ListarFuncionariosSecao('all', $dados);
        ...
        return parent::ViewPortal('variaveis/aluguel/novo', $dados);
    }

    public function editar($id){
        $id = base64_decode($id);
     
        $dados['_titulo'] = "Editar Auxilio Aluguel";
        $dados['rh'] = parent::VerificaPerfil('GLOBAL_RH', false);
        ...
        $this->_breadcrumb->add('Editar Auxilio Aluguel');

        return parent::ViewPortal('variaveis/aluguel/update', $dados);
    }
