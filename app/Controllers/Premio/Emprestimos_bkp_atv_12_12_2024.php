...
class Emprestimos extends BaseController
{
  ...
  public function index()
  {
    ...
    $dados['_titulo'] = "Empréstimo de Colaborador";
  ...
  public function novo()
  {
    ...
    $dados['_titulo'] = "Novo Empréstimo de Colaborador";
    $this->_breadcrumb->add('Novo Empréstimo');
  ...
  public function aprovacao()
  {
    ...
    $dados['_titulo'] = "Aprovação de Empréstimo de Colaborador";
    $dados['isAdmin'] = ($_SESSION['log_id'] == 1 or $_SESSION['rh_master'] == 'S') ? true : false;
