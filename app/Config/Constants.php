...
define('TAMANHO_FUNCAO', 5);
define('INTEGRIDADE', true);
...
/*
 ...
 |
 */
define('EMAIL_SMTP', '10.254.196.109');
define('EMAIL_PORTA', 25);
define('EMAIL_USUARIO', 'joseajg');
define('EMAIL_SENHA', 'timao10');
define('EMAIL_NOME_REMETENTE', 'Portal RH');
define('EMAIL_EMAIL_REMETENTE', 'portalrh@eldoradobrasil.com.br');
define('EMAIL_CRYPTO', 'tls'); // tls, ssl, ''
define('EMAIL_PROTOCOLO', 'mail'); // mail, sendmail, smtp
define('EMAIL_DEBUG', false); // true, false


/*
 | --------------------------------------------------------------------------
 | Parametros Banco de Dados Portal
 | --------------------------------------------------------------------------
 |
 */
