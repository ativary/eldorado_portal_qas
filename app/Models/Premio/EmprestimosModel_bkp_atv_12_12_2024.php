...
class EmprestimosModel extends Model {
    ...
    public function CadastrarEmprestimo($dados){
        ...
        if($email_para_chapa == "") {
            return responseJson('error', 'Falha ao criar solicitação de empréstimo. Email do destinatário não encontrado.');
        }
        ...
        if($this->dbportal->affectedRows() > 0) {
            ...
            $mensagem = '
				...
				<br>
				Venho por meio desta solicitar sua aprovação para o empréstimo de um colaborador de minha equipe para sua equipe de trabalho, durante o período especificado abaixo:<br>
                <br>
            ...
            //$response = enviaEmail('alvaro.zaragoza@ativary.com', 'Solicitação de Empréstimo de Colaborador', $htmlEmail);
            $response = enviaEmail($email_para_chapa, 'Solicitação de Empréstimo de Colaborador', $htmlEmail);
            
            session()->set(array('notificacao' => array('success', '<i class="mdi mdi-check-all alert-icon"></i> Solicitação de empréstimo criada com sucesso.')));
            return responseJson('success', 'Solicitação de empréstimo criada com sucesso', $this->dbportal->insertID());
    
        } else {

            return responseJson('error', 'Falha ao criar solicitação de empréstimo');
    ...
    public function DeletarEmprestimo($dados = false){
        ...
        return ($this->dbportal->affectedRows() > 0) 
                ? responseJson('success', 'Solicitação de empréstimo excluída com sucesso')
                : responseJson('error', 'Falha ao excluir solicitação de empréstimo');
    ...
    public function AprovarEmprestimo($dados = false){
        ...
        if($email_de_chapa == "") {
            return responseJson('error', 'Falha ao aprovar empréstimo. Email do destinatário não encontrado.');
        }
        ...
        if ($this->dbportal->affectedRows() > 0) {
            ...
            <br>
            Venho por meio desta informar que sua solicitação de empréstimo de colaborador foi APROVADA.<br>
            <br>
            ...
            //$response = enviaEmail('alvaro.zaragoza@ativary.com', 'Solicitação de Empréstimo de Colaborador', $htmlEmail);
            $response = enviaEmail($email_de_chapa, 'Solicitação de Empréstimo de Colaborador - APROVADA', $htmlEmail);

            return responseJson('success', 'Solicitação de empréstimo aprovada com sucesso');

        } else {
            return responseJson('error', 'Falha ao aprovar solicitação de empréstimo');
        }
    ...
    public function ReprovarEmprestimo($dados = false){
        ...
        if($email_de_chapa == "") {
            return responseJson('error', 'Falha ao reprovar empréstimo. Email do destinatário não encontrado.');
        }
        ...
        if ($this->dbportal->affectedRows() > 0) {
            ...
            Prezado <strong>'.$de_nome_func.'</strong>, <br>
            <br>
            Venho por meio desta informar que sua solicitação de empréstimo de colaborador foi REPROVADA.<br>
            <br>
            Colaborador: '.$colaborador_nome_func.' ('.$chapa_colaborador.')<br>
            Prêmio: '.$nome_premio.'<br>
            Período: '.$per_ponto_br.'<br>
            ...
            $response = enviaEmail($email_de_chapa, 'Solicitação de Empréstimo de Colaborador - REPROVADA', $htmlEmail);

            return responseJson('success', 'Solicitação de empréstimo foi reprovada');

        } else {
            return responseJson('error', 'Falha ao reprovar solicitação de empréstimo');
        }
            ...
            foreach($resFuncs as $key => $Func): 
                ...
                if($email_para_chapa != "") {
                    ...
                    $mensagem = '
                        Prezado Gestor <strong>'.$nome_para_chapa.'</strong>, <br>
                        <br>
                        Venho por meio desta solicitar o empréstimo de um colaborador de minha equipe para sua equipe de trabalho, durante o período especificado abaixo:<br>
                        <br>
                        Colaborador: '.$nome_chapa_colaborador.' ('.$chapa_colaborador.')<br>
                        Prêmio: '.$nome_premio.'<br>
                        Período: '.$per_ponto_br.'<br>
                    ...
                    //$response = enviaEmail('alvaro.zaragoza@ativary.com', 'Solicitação de Empréstimo de Colaborador', $htmlEmail);
                    $response = enviaEmail($email_para_chapa, 'REENVIANDO - Solicitação de Empréstimo de Colaborador', $htmlEmail);
