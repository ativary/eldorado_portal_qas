...
class EspelhoModel extends Model {
    ...
    // -------------------------------------------------------
    public function ListarEspelhoDias($periodo, $chapa){
    ...
    // Lista dias do período
    // -------------------------------------------------------
    public function ListarEspelhoBatidas($periodo, $chapa){
        ...
        $batidasPortal = self::ListarEspelhoBatidasPortal($chapa, $dataInicio, $dataFim);
        $BATIDAS_PORTAL = "";
        ...
        if($batidasPortal){
            foreach($batidasPortal as $key => $BatidaPortal){
                $BATIDAS_PORTAL .= " UNION ALL SELECT '{$chapa}' CHAPA, '{$BatidaPortal['DATA']}' DATA, '{$BatidaPortal['DATAREFERENCIA']}' DATAREFERENCIA, {$BatidaPortal['BATIDA']} BATIDA, 'D' STATUS, {$BatidaPortal['NATUREZA']} NATUREZA, '{$BatidaPortal['DATAINSERCAO']}' DATAINSERCAO, '{$BatidaPortal['DATABATIDA']}' DATABATIDA, {$BatidaPortal['BATIDA_NOTURNA']} BATIDA_NOTURNA, 1 PORTAL, 0 IDAAFDT, '{$BatidaPortal['MOTIVO_REPROVA']}' MOTIVO_REPROVA {$from_dual} ";
    ...
    public function ListarEspelhoBatidasPortal($chapa, $dataInicio, $dataFim){
    ...
    public function CadastrarBatida($dados, $arquivos = null, $tem_anexo = false){
        ...
        try {
            ...
            $batidasRegistradas = self::ListarEspelhoBatidas($data_batida.$data_batida, $chapa);
