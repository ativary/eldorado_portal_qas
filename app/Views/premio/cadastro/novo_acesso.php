        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer text-center">
                    <button class="btn btn-success bteldorado_1" id="btnsave" onclick="return salvaDados()"><i class="fas fa-save"></i> Cadastrar Acesso</button>
                </div>
...
const salvaDados = () => {
    ...
    <?php if ($resAcessos) {?>
        <?php foreach($resAcessos as $key => $Acesso): ?>
            ...
            if($("#dtper_ponto").val().substring(0, 10) == "<?= $Acesso['dtini_ponto']; ?>"){ exibeAlerta("error", "Essa <b>Período de Ponto</b> já existe em outro período de acessos cadastrado."); return false; }
        <?php endforeach; ?>
    <?php }?>
    ...
    $.ajax({
        url: "<?= base_url('premio/cadastro/action_acessos/cadastrar'); ?>",
        type:'POST',
        data:dados,
