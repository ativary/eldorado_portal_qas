        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer text-center">
                    <button class="btn btn-secondary" id="btn-importar" disabled onclick="return importarPremissas()"><i class="ti-arrow-down"></i> Importar Premissas</button>
                </div>
...
<script>
const importarPremissas = () => {

    Swal.fire({
        icon: 'question',
        title: 'Confirma a importação das premissas?',
        showDenyButton: true,
        ...
        if (result.isConfirmed) { 
            ...
            $.ajax({
                url: "<?= base_url('premio/cadastro/action_premissas/importacao') ?>",
                type:'POST',
                processData: false,
                contentType: false,
                data: fd,
