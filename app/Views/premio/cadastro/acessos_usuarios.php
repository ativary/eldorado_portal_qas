                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <div class="button-items">
                                <a href="<?= base_url('premio/cadastro/acessos/'.$resAcesso[0]['id_premio']) ?>" class="btn btn-primary btn-xxs mb-0"><i class="far fa-arrow-alt-circle-left"></i> Voltar</a>
                            </div>
                        </div>
                    </div>
                </div>
...
const excluir = (id) => {
    ...
    Swal.fire({
		...
		if (result.isConfirmed) {
			...
			$.ajax({
				url: "<?= base_url('premio/cadastro/action_acessos/deletar_usuario') ?>",
				type:'POST',
				data:dados,
...
const adicionar = () => {
    ...
    $.ajax({
        url: "<?= base_url('premio/cadastro/action_acessos/adicionar_usuario'); ?>",
        type:'POST',
        data:dados,
        success:function(result){
            ...
            if(response.tipo != 'success'){
                ...
                window.location.reload();
                //exibeAlerta(response.tipo, response.msg, 2, '<?= base_url('premio/cadastro/acessos_usuarios/'.$id_acesso) ?>');
            }
...
const importar = () => {
    ...
    $.ajax({
        url: "<?= base_url('premio/cadastro/action_acessos/importar_usuarios'); ?>",
        type:'POST',
        data:dados,
        success:function(result){
