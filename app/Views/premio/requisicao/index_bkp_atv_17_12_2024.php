                                    ...
                                    <tr data-linha="<?= $Requisicao['id'] ?>">
                                        ...
                                        <?php
                                            switch($Requisicao['status']){
                                                case 'S': echo '<span class="badge badge-success">&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSincronizado&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>'; break;
                                                case 'H': echo '<span class="badge badge-success">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAprovado&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>'; break;
                                                case 'A': echo '<span class="badge badge-warning">Aguardando RH Calcular</span>'; break;
                                                case 'C': echo '<span class="badge badge-purple">Aguardando RH Aprovar</span>'; break;
                                                case 'E': echo '<span class="badge badge-info">Aguardando Aprovação</span>'; break;
                                                case 'R': echo '<span class="badge badge-danger">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspReprovada&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>'; break;
                                                case 'P': echo '<span class="badge badge-primary">&nbsp&nbspEm preparação&nbsp&nbsp</span>'; break;
                                                default: echo '';
                                            }
                                        ?>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" aria-label="acao" role="group">
                                                <button id="btn_enviar" name="btn_enviar" onclick="return requisitar(<?= $Requisicao['id']; ?>)" class="btn btn-soft-success waves-effect waves-light btn-xxs" <?php if(!($Requisicao['status'] == 'P' or $Requisicao['status'] == 'R')) { echo 'disabled';}?>><i class="fa fa-paper-plane"></i></button>
                                                <button id="btn_excluir" name="btn_excluir" onclick="return excluir(<?= $Requisicao['id']; ?>)" class="btn btn-soft-pink waves-effect waves-light btn-xxs" <?php if(!($Requisicao['status'] == 'P')) { echo 'disabled';}?>><i class="fa fa-times"></i></button>
...
Swal.fire({
    icon: 'question',
    title: 'Deseja enviar esta requisição para <b>aprovação</b>?',
    showDenyButton: true,
    showCancelButton: true,
