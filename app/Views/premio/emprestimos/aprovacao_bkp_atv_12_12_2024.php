...
const ver = (id) => {
    ...
    if (result) {
        Swal.fire({
            title: "Dados da solicitação do Empréstimo",
            html: `
...
const reprovar = async (id) => {
    const { value: motivo } = await Swal.fire({
        input: "textarea",
        inputLabel: "Motivo de reprovação do empréstimo",
        inputPlaceholder: "Digite o motivo de reprovação do empréstimo...",
        inputAttributes: {
    ...
    if (motivo) {
        ...
        Swal.fire({
            icon: 'question',
            title: 'Confirma a reprovação do <b>empréstimo</b>?',
            showDenyButton: true,
            showCancelButton: true,
...
const aprovar = (id) => {
    ...
    Swal.fire({
		icon: 'question',
		title: 'Deseja aprovar esse <b>empréstimo</b>?',
		showDenyButton: true,
		showCancelButton: true,
