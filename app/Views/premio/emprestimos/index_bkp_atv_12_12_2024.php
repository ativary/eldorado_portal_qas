        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header mt-0">
                    ...
                    <div class="col-6 text-right">
                        <div class="button-items">
                            <a href="<?= base_url('premio/emprestimos/novo') ?>" class="btn btn-primary btn-xxs mb-0"><i class="fas fa-plus-circle"></i> Novo Empréstimo</a>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <?php if($resAprovar != []): ?>
                        <a href="<?= base_url('premio/emprestimos/aprovacao') ?>" class="col-12 btn btn-soft-danger waves-effect waves-light">Existem empréstimos para serem aprovados. <i class="fa fa-eye"></i> Clique aqui para visualizar.</a>
...
const ver = (id) => {
    ...
    if (result) {
        ...
        Swal.fire({
            title: "Dados da solicitação de Empréstimo",
            html: `
