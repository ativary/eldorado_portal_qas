                        ...
                        <div class="form-group row mb-0" >
                            ...
                            <div class="col-sm-10">
                                <select onchange="selecionaRelatorio(this.value)" class="select2 custom-select form-control form-control-sm" name="relatorio" id="relatorio">
                                    ...
                                    <?php if($rh): ?><option value="26" <?php if($relatorio == 26){ echo 'selected';}?>> Origem de Batidas</option><?php endif; ?> 
                                    <?php if($rh): ?><option value="27" <?php if($relatorio == 27){ echo 'selected';}?>> Batidas Sincronizadas</option><?php endif; ?> 
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-0" >
