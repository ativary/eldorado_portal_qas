                                    ...
                                    <table class="table table-bordered" id="horasTable">
                                        ...
                                        foreach ($horarios as $key2 => $dados2) : ?>
                                            <tr>
                                                ...
                                                <td class="n-mobile-cell"><?= $dados2->hora_inicio ?></td>
                                                <td class="n-mobile-cell"><?= dtBr($dados2->data_fim) ?></td>
                                                <td class="n-mobile-cell"><?= $dados2->hora_fim ?></td>
                                                <td class="n-mobile-cell"><?= $dados2->tot_horas ?></td>
...
document.getElementById('btnimportar').addEventListener('click', function () {
    ...
    for (let i = 1; i < dadosImportados.length; i++) {
        ...
        console.log(typeof dataIni, dataIni);
