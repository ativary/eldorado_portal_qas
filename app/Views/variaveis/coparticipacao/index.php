                ...
                <div class="card-header mt-0">
                    ...
                    <div class="col-6 text-right">
                        <div class="button-items">
                            <a href="<?= base_url('variaveis/coparticipacao/novo') ?>" class="btn btn-primary btn-xxs mb-0"><i class="fas fa-plus-circle"></i> Nova Requisição</a>
                        </div>
                    </div>
                    </div>
                </div>
                                        ...
                                        <div class="btn-group dropleft mb-2 mb-md-0">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="<?= base_url('variaveis/coparticipacao/editar/'.base64_encode($dados->id)); ?>" class="dropdown-item <?= ($dados->status != '1') ? 'disabled' : ''; ?>">Editar requisição</a>
...
<div class="modal-dialog" style="max-width: 90%; width: 90%;">
        <div class="modal-content modal-content-full">
            <div class="modal-header bg-dark">
                <h5 class="modal-title mt-0 text-white"><i class="mdi mdi-file-document-box-outline"></i>  Coparticipação</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><i class="mdi mdi-close-circle-outline"></i></button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="tab-pane active p-3" id="auxilio_moradia" role="tabpanel">
                                <div class="form-group row mb-2">
                                    <label for="tipoReq" class="col-sm-2 col-form-label text-right text-left-sm">Prestadora:</label>
                                    <div class="col-sm-8">
...
<script>
    ...
    const salvaAnexo = () => {
        ...
        $.ajax({
            url: "<?= base_url('variaveis/coparticipacao/salvarAnexo'); ?>",  // Altere para a URL do seu endpoint de upload
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    const selecionaFuncionario = (codigo) => {
        ...
        $.ajax({
            url: "<?= base_url('variaveis/coparticipacao/selectFunc'); ?>",
            type:'POST',
            data:dados,
            success:function(result){
    ...
    $.ajax({
        url: "<?= base_url('variaveis/coparticipacao/Anexos'); ?>",
        type: "POST",
        data: {
            "id": id
        },
    ...
    const Filtro = () => {
		...
		openLoading();
		$("#form_filtro").attr('action', base_url + '/variaveis/coparticipacao').attr('target', '_self');
    ...
    const excluirAnexo = (id ) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?= base_url('variaveis/coparticipacao/deleteAnexo'); ?>",
                    type: 'POST',
    ...
    const excluirReq = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                openLoading();
                $.ajax({
                    url: "<?= base_url('variaveis/coparticipacao/delete'); ?>",
                    type: 'POST',
                    data: dados, // Enviar o ID para exclusão
                    success: function(result) {
                        console.log(result);
