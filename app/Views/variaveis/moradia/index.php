                ...
                <div class="card-header mt-0">
                    ...
                    <div class="col-6 text-right">
                        <div class="button-items">
                            <a href="<?= base_url('variaveis/moradia/novo') ?>" class="btn btn-primary btn-xxs mb-0"><i class="fas fa-plus-circle"></i> Nova Requisição</a>
                        </div>
                    </div>
                    </div>
                </div>
                                        ...
                                        <div class="btn-group dropleft mb-2 mb-md-0">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="<?= base_url('variaveis/moradia/editar/'.base64_encode($dados->id)); ?>" class="dropdown-item <?= ($dados->status != '1') ? 'disabled' : ''; ?>">Editar requisição</a>
        ...
        <div class="modal-content modal-content-full">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control filepond" type="file" name="anexo[]" id="anexo"  required  accept="application/pdf, image/jpeg">
...
<script>
    ...
    const selecionaFuncionario = (codigo) => {
        ...
        $.ajax({
            url: "<?= base_url('variaveis/moradia/selectFunc'); ?>",
            type:'POST',
            data:dados,
            success:function(result){
    ...
    const Filtro = () => {
		...
		openLoading();
		$("#form_filtro").attr('action', base_url + '/variaveis/moradia').attr('target', '_self');
    ...
    const excluirReq = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                openLoading();
                $.ajax({
                    url: "<?= base_url('variaveis/moradia/delete'); ?>",
                    type: 'POST',
                    data: dados, // Enviar o ID para exclusão
                    success: function(result) {
                        console.log(result);
