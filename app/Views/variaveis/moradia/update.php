                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <div class="button-items">
                                <a href="<?= ($req[0]->status == '3' || $req[0]->status == '7'  ) ? base_url('variaveis/sincronizacao') : base_url('variaveis/moradia'); ?> " class="btn btn-primary btn-xxs mb-0"><i class="far fa-arrow-alt-circle-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </div>
...
function verificaData() {
    ...
    // opção "Complementar"
    const dia_lim_compl = parseInt(regra.dia_limite_compl6, 10);
...
const salvaDados = () => {
    ...
    $.ajax({
        url: "<?= base_url('variaveis/moradia/update'); ?>",
        type:'POST',
        data:formData,
        ...
        success:function(result){
            ...
            if(response.tipo != 'success'){
                ...
                exibeAlerta(response.tipo, response.msg, 3, '<?=($req[0]->status == '3' || $req[0]->status == '7'  ) ? base_url('variaveis/sincronizacao') : base_url('variaveis/moradia');?> ');
            }
