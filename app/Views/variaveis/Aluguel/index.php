                ...
                <div class="card-header mt-0">
                    ...
                    <div class="col-6 text-right">
                        <div class="button-items">
                            <a href="<?= base_url('variaveis/aluguel/novo') ?>" class="btn btn-primary btn-xxs mb-0"><i class="fas fa-plus-circle"></i> Nova Requisição</a>
                        </div>
                    </div>
                    </div>
                </div>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" id="datatable" class="table table-sm table-striped table-bordered">
                        <thead>
                            <tr class="text-center">
                                <th class="n-mobile-cell"><input type="checkbox" onchange="toggleButtonVisibility()" id="select-all"></th>
                                <td class="n-mobile-cell" width="40" data-orderable="false">Nº da requisição</td>
                                        ...
                                        <div class="btn-group dropleft mb-2 mb-md-0">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="<?= base_url('variaveis/aluguel/editar/'.base64_encode($dados->id)); ?>" class="dropdown-item <?= ($dados->status != '1') ? 'disabled' : ''; ?>">Editar requisição</a>
...
<div class="modal-dialog" style="max-width: 90%; width: 90%;">
        <div class="modal-content modal-content-full">
            <div class="modal-header bg-dark">
                <h5 class="modal-title mt-0 text-white"><i class="mdi mdi-file-document-box-outline"></i> Auxilio Aluguel</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><i class="mdi mdi-close-circle-outline"></i></button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#auxilio_aluguel" role="tab"><i class="fa fa-home"></i> Auxílio aluguel</a>
                            </li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="tab-pane active p-3" id="auxilio_aluguel" role="tabpanel">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <select disabled  class="select2 custom-select form-control form-control-sm" name="quantMes" id="quantMes">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input disabled class="form-control form-control-sm " data-money  type="text" value="" name="valor" id="valor" required>
...
<script>
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    ...
                                    if (response.tipo != 'success') {
                                        ...
                                        exibeAlerta(response.tipo, response.msg, 3, '<?= base_url('variaveis/aluguel'); ?>');
                                    }
                                },
    ...
    const selecionaFuncionario = (codigo) => {
        ...
        $.ajax({
            url: "<?= base_url('variaveis/aluguel/selectFunc'); ?>",
            type:'POST',
            data:dados,
            success:function(result){
    ...
    $.ajax({
        url: "<?= base_url('variaveis/aluguel/Anexos'); ?>",
        type: "POST",
        data: {
            "id": id
        },
    ...
    const abrirReq = (dados) => {
        ...
        const novoTitulo = `Auxilio Aluguel - ${req.id}`; // Exemplo de como construir o novo título
        ...
        $("#quantMes").append($('<option></option>')
        .attr('value', valor.quantMes)
        .attr('selected', true) // Define a opção como selecionada
        .text(valor.quantMes +' Meses '));
    ...
    const Filtro = () => {
		...
		openLoading();
		$("#form_filtro").attr('action', base_url + '/variaveis/aluguel').attr('target', '_self');
    ...
    const excluirAnexo = (id ) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?= base_url('variaveis/aluguel/deleteAnexo'); ?>",
                    type: 'POST',
    ...
    const excluirReq = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                openLoading();
                $.ajax({
                    url: "<?= base_url('variaveis/aluguel/delete'); ?>",
                    type: 'POST',
                    data: dados, // Enviar o ID para exclusão
                    success: function(result) {
                        console.log(result);
