                ...
                <div class="card-header mt-0">
                    ...
                    <div class="col-6 text-right">
                        <div class="button-items">
                            <a href="<?= base_url('variaveis/desconto/novo') ?>" class="btn btn-primary btn-xxs mb-0"><i class="fas fa-plus-circle"></i> Nova Requisição</a>
                        </div>
                    </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row mb-2">
							...
							<div class="col-sm-10">
								<select class="select2 custom-select form-control form-control-sm" name="situacao" id="situacao">
                                    ...
                                    <option value="9"<?= ($situacao == '9'  ) ? 'selected' : ''; ?>>  Pendente Documento </option>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" id="datatable" class="table table-sm table-striped table-bordered">
                        <thead>
                            <tr class="text-center">
                                ...
                                <td class="n-mobile-cell" width="20" >Nº da requisição</td>
                                ...
                                <td class="n-mobile-cell">Tipo Desconto</td>
                            ...
                            <?php if ($listaReqs) : ?>
                                <?php foreach ($listaReqs as $key => $dados) : ?>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="n-mobile-cell"><?= isset($valores->quantMes) && $valores->quantMes != 'undefined' ? $valores->quantMes : '-' ?></td>
...
<div class="modal-dialog" style="max-width: 90%; width: 90%;">
        <div class="modal-content modal-content-full">
            <div class="modal-header bg-dark">
                <h5 class="modal-title mt-0 text-white"><i class="mdi mdi-file-document-box-outline"></i>  Desconto Autorizado</h5>
                <button type="button" class="close text-white" data-dismiss="modal"><i class="mdi mdi-close-circle-outline"></i></button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="tab-pane active p-3" id="auxilio_desconto" role="tabpanel">
                                <div class="form-group row mb-2">
                                    <label for="tipoReq" class="col-sm-2 col-form-label text-right text-left-sm">Tipo de Desconto:</label>
                                    <div class="col-sm-8">
...
<script>
    ...
    const salvaAnexo = () => {
        ...
        $.ajax({
            url: "<?= base_url('variaveis/desconto/salvarAnexo'); ?>",  // Altere para a URL do seu endpoint de upload
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $.ajax({
        url: "<?= base_url('variaveis/desconto/Anexos'); ?>",
        type: "POST",
        data: {
            "id": id
        },
    ...
    const abrirReq = (dados) => {
        ...
        const novoTitulo = `Desconto Autorizado - ${req.id}`; // Exemplo de como construir o novo título
    ...
    const Filtro = () => {
		...
		openLoading();
		$("#form_filtro").attr('action', base_url + '/variaveis/desconto').attr('target', '_self');
    ...
    const excluirAnexo = (id ) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?= base_url('variaveis/desconto/deleteAnexo'); ?>",
                    type: 'POST',
    ...
    const excluirReq = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                openLoading();
                $.ajax({
                    url: "<?= base_url('variaveis/desconto/delete'); ?>",
                    type: 'POST',
                    data: dados, // Enviar o ID para exclusão
                    success: function(result) {
                        console.log(result);
