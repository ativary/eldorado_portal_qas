                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <div class="button-items">
                                <a href="<?= base_url('variaveis/creche') ?>" class="btn btn-primary btn-xxs mb-0"><i class="far fa-arrow-alt-circle-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    if($("#tipoReq").val() == "2" && fora_periodo == 2){ 
     ...
     if( $("#tipoReq").val() == '1' && fora_periodo == 1){
        fora_periodo = 2;
     }
    ...
    $.ajax({
        url: "<?= base_url('variaveis/creche/save'); ?>",
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
function verificarLimite(input) {
    ...
    valorLimite = regra.reembolso_creche_valor_demais_filiais;
    limitePermitido = parseFloat(regra.reembolso_creche_valor_demais_filiais);
