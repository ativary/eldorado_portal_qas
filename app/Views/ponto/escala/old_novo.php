                ...
                <div class="card hidden" id="box_projecao">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card border mt-4 hidden box_justificativa_6_dias" style="background: #fffbec; border-color: #ebd9a6 !important;">
                            <div class="card-body">
                                <div class="col-sm-12">
                                    <label for="justificativa_6_dias" class="col-form-label text-left">Justificativa (Funcionário possui mais de 6 dias trabalhados consecutivos):</label>
                        ...
                        <div class="card border mt-4 hidden box_justificativa_6_meses" style="background: #fffbec; border-color: #ebd9a6 !important;">
                            <div class="card-body">
                                <div class="col-sm-12">
                                    <label for="justificativa_6_meses" class="col-form-label text-left">Justificativa (Troca de escala não permitida antes de 6 meses do horário atual do funcionário):</label>
...
const salvaDados = () => {
    ...
    if(qtde_dias_trab > 6 && !precisa_justificar_6_dias){
        ...
        <?php endif; ?>
        exibeAlerta('warning', 'Funcionário possui mais de 6 dias trabalhados consecutivos.');
        return false;
    }
    ...
    if(justificativa_6_dias == "" && precisa_justificar_6_dias){
        exibeAlerta('warning', 'Justificativa (Funcionário possui mais de 6 dias trabalhados consecutivos.');
        return false;
    }

    if(justificativa_6_meses == "" && precisa_justificar_6_meses){
        exibeAlerta('warning', 'Justificativa (Troca de escala não permitida antes de 6 meses do horário atual do funcionário) não informada.');
        return false;
    }
    <?php endif; ?>
