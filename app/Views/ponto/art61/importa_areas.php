        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <div class="button-items">
                                <a href="<?= base_url('ponto/art61/config/2') ?>" class="btn btn-primary btn-xxs mb-0"><i class="far fa-arrow-alt-circle-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer text-center">
                    <button class="btn btn-secondary" id="btn-importar" disabled onclick="return importarArea()"><i class="ti-arrow-down"></i> Importar Centros de Custo</button>
                </div>
...
const importarArea = () => {
    ...
    Swal.fire({
        icon: 'question',
        title: 'Confirma a importação de Centros de Custo?',
        showDenyButton: true,
            ...
            $.ajax({
                ...
                success:function(result){
                    //try {
                        ...
                        exibeAlerta(response.tipo, response.msg, 6, '<?= base_url('ponto/art61/config/2/') ?>');
