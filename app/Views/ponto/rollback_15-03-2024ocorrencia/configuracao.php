									...
									<td class="text-center">
										<div class="btn-group dropleft mb-2 mb-md-0">
											...
											<div class="dropdown-menu">
												<button type="button" class="dropdown-item" title="Configurar Horário" onclick="return configurarCiclo('<?= $Horario['CODIGO']; ?>', '<?= trim($Horario['DESCRICAO']); ?>')"><i class="mdi mdi-reload"></i> | Configurar Horário</button>
											</div>
                                    	</div>
									</td>
								</tr>
                ...
                <div class="row">
                    <div class="col-12">
						...
						<table class="table table-sm text-xs table-bordered" data-detalhes-horario>
							<thead class="bg-info">
								<tr>
									<th class="text-white text-center" width="70">Entrada1</th>
									<th class="text-white text-center" width="70">Saida1</th>
									<th class="text-white text-center" width="70">Entrada2</th>
									<th class="text-white text-center" width="70">Saida2</th>
				...
				for(var x=0; x<response.length; x++){
					$("[data-detalhes-horario] tbody").append(`
						<tr>
							...
							<td><input data-codhorario="${response[x].CODHORARIO}" data-indice="${response[x].CODINDICE}" type="number" class="form-control form-control-sm text-center" value="${response[x].CICLO}"></td>
