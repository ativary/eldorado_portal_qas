                                    ...
                                    <table class="table table-bordered mb-0 table-centered table-sm table-striped" style="border-collapse: collapse; border-spacing: 0; width: 100%; font-size: 11px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td data-excesso_abono_gestor_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['excesso_abono_gestor'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-extra_permitido_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['extra_permitido'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-extra_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['extra'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-interjornada_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['interjornada'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-jornada_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['jornada'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-registro_britanico_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['registro_britanico'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-registro_manual_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['registro_manual'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-pendente_termo_aditivo_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['pendente_termo_aditivo'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-sobreaviso_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['sobreaviso'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-trabalho_dsr_folga_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['trabalho_dsr_folga'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-trabalho_dsr_folga_descanso_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['trabalho_dsr_folga_descanso'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-trabalho_ferias_afastamento_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['trabalho_ferias_afastamento'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-trabalho_6dias_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['trabalho_6dias'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-troca_menor_10_dias_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['troca_menor_10_dias'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-troca_menor_6_meses_tratado class="text-center"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['troca_menor_6_meses'] : "0"; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="background-color: #dee2e6; font-weight: bold;"><label class="col-form-label text-left pt-0 pb-0"><?= ($resOcorrenciaJustificadas) ? (int)$resOcorrenciaJustificadas[0]['total'] : "0"; ?></label></td>
                            ...
                            <?php foreach($resDadosFunc as $key => $DadosFunc): ?>
                                <?php foreach($DadosFunc['DATAS'] as $key2 => $Data): ?>
                                    ...
                                    <tr data-linha="<?= $linha; ?>">
                                        ...
                                        <td class="text-center"><a href="javascript:void(0);" onclick="abreBatidasDia('<?= $DadosFunc['CHAPA']; ?>', '<?= dtBr($Data); ?>', '<?= $DadosFunc['NOME']; ?>')"><?= dtBr($Data); ?></a><br><b><?= diaSemana($Data, true); ?></b>
                                                ...
                                                if($Ocorrencias['OCORRENCIA'] == "troca_menor_6_meses"){
                                                    ...
                                                    if(strlen(trim($codmotivo)) <= 0){
                                                        if(isset($qtde_ocorrencia['troca_menor_6_meses'])){
                                                            $qtde_ocorrencia['troca_menor_6_meses']['qtde'] = $qtde_ocorrencia['troca_menor_6_meses']['qtde'] + 1;
                                                        }else{
                                        ...
                                        <?php endif; ?>
                                        <td>
                                            <select <?= ($bloqueiaAlteracao) ? " disabled " : ""; ?> data-motivo="<?= $linha; ?>" name="motivo[]" class="form-control form-control-sm">
                                                <?php if($resMotivo): ?>
                                                    <option value="">...</option>
...
<script>
    ...
    const abreBatidasDia = (chapa, data, nome) => {
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                try {
                    ...
                    var aviso = (response.AVISO != '') ? response.AVISO : '';
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <h4 data-colaborador class="m-0"></h4>
                        <hr>
                        <p class="m-0">
                            <b>Legenda:</b> 
