            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="" name="perfil_nome" id="perfil_nome" require>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="perfil_descricao" class="col-sm-2 col-form-label text-right">Descrição:</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="perfil_descricao" id="perfil_descricao" cols="30" rows="3"></textarea>
                        </div>
                    </div>
...
const salvaDados = () => {
    ...
    $.ajax({
        url: "<?= base_url('manager/perfil/action/cadastrar'); ?>",
        type:'POST',
        data:dados,
        success:function(result){
            ...
            if(response.tipo != 'success'){
                ...
                exibeAlerta(response.tipo, response.msg, 3, '<?= base_url('manager/perfil/editar'); ?>/'+response.cod);
            }
