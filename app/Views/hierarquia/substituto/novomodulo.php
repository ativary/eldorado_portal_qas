        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-8 col-xl-8">
                                <input id="nomeModulo" class="form-control form-control-sm " type="text"/>
                            </div>
                            
                            <div class="col-2 col-xl-2">
                                <input id="aprovador" class=" " type="checkbox"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="input-group d-flex align-items-center row">
                                    <div class="col-1">
                                        <label for="perfil" class="col-form-label text-left pr-0">Perfis:</label>
                                    </div>
                                    <div class="col-8">
                                        <select onchange="carregarDualList(this.value)" name="perfil" class="select2 form-control form-control-sm">
                ...
                <div class="card-footer text-center">
                        <button class="btn btn-success bteldorado_7" id="btnsave" onclick="return cadastrarModulo()"><i class="mdi mdi-content-save-outline"></i> Salvar</button>
                </div>
            </div>
        </div>
