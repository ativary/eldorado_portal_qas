            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="descricao" id="descricao" class="form-control" value="<?= $Pagina['descricao']; ?>">
                    </div>

                    <div class="form-group">
                        <textarea id="texto_pagina" name="texto_pagina"><?= base64_decode($Pagina['texto']); ?></textarea>
                    </div>
...
const salvaDados = () => {
    ...
    if(dados.id_pagina == 0){ exibeAlerta("error", "<b>ID Página</b> não encontrado."); return false; }

    openLoading();

    $.ajax({
        url: "<?= base_url('remuneracao/cartas/action/editar_pagina'); ?>",
        type:'POST',
        data:dados,
