...
function dadosOcorrencia($Ocorrencia){
    ...
    switch($Ocorrencia['OCORRENCIA']){
        case 'extra_permitido': return m2h($Ocorrencia['VALOR']); break;
        ...
        case 'trabalho_6dias': return $Ocorrencia['COMPLEMENTO']; break;
        case 'excesso_abono_gestor': return $Ocorrencia['COMPLEMENTO']; break;
        case 'interjornada': return $Ocorrencia['COMPLEMENTO']; break;
        case 'intrajornada': return $Ocorrencia['COMPLEMENTO']; break;
